...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cityNames = [
        "New York", "London", "Tokyo", "Sydney", "Los Angeles", "Paris", "Dubai", "Shanghai", "Moscow", "Rio",
        "Cape Town", "Delhi", "Auckland", "Anchorage", "Honolulu", "Cairo", "Beijing", "Singapore", "Berlin", "Mexico City"
    ];
    ...
    async function setFavorite(cityName) {
        ...
        // --- Save to Firestore ---
        try {
            // You need to have userId in sessionStorage or similar
            const userId = sessionStorage.getItem("userId");
            if (userId) {
                const userDocRef = doc(db, "users", userId);
                // Save favorite city as a field in the user document
